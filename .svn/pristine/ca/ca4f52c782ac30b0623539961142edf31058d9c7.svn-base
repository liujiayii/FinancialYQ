			...
			<form action="##" id="save" target="nm_iframe" method="post" enctype="multipart/form-data">
				...
				<table class="control_tab">
					<tr>
						<td class="tab_01">分公司</td>
								...
								<input type="hidden" name="area" value="${finance.area}" id="selectArea">
									 <select id ="area" name="area" class="width_01" style="border: 1px solid #dcdcdc;padding-left:10px">										
					...
					<tr>
						...
						<td width="79">建表人</td>
						<td class="width_01">
							<input type="hidden" value="${finance.riskman}" id="selectRiskman">
				...
				<table id="myTable" class="control_tab controls_table" style="text-align:center;width:865px;"border="1">
					...
					<tr>
						...
						<td colspan="3" style="position:relative">
							...
							<input type="text" name="principal" class="amount" value="${finance.principal}"   style="border:none;float:left">
						</td>
					</tr>
					</c:if>
				...
				<c:if test="${not empty finance.serviceMoney}">
					<tr>
						...
						<td colspan="3" style="position:relative">
							...
							<input type="text" name="serviceMoney" class="amount" value="${finance.serviceMoney}"  maxlength="12" style="border:none;float:left">
						</td>
					</tr>
				</c:if>
				<c:if test="${not empty finance.houseProperty}">
					<tr>
						...
						<td colspan="3" style="position:relative">
							...
							<input type="text" name="houseProperty" class="amount" value="${finance.houseProperty}"  maxlength="12" style="border:none;float:left">
						</td>
					</tr>
				</c:if>
				<c:if test="${not empty finance.archivesMoney}">
					<tr>
						...
						<td colspan="3" style="position:relative">
							...
							<input type="text" name="archivesMoney" class="amount" value="${finance.archivesMoney}"  maxlength="12" style="border:none;float:left">
						</td>
					</tr>
				</c:if>
				<c:if test="${not empty finance.capitalMoney}">
					<tr>
						...
						<td colspan="3" style="position:relative">
							...
							<input type="text" name="capitalMoney" class="amount" value="${finance.capitalMoney}"  maxlength="12" style="border:none;float:left">
						</td>
					</tr>
				</c:if>
				<c:if test="${not empty finance.account}">
					<tr>
						...
						<td colspan="3" style="position:relative">
							...
							<input type="text" name="account" class="amount" value="${finance.account}"  maxlength="12" style="border:none;float:left">
						</td>
					</tr>
				</c:if>
				<c:if test="${not empty finance.landMoney}">
					<tr>
						...
						<td colspan="3" style="position:relative">
							...
							<input type="text" name="landMoney" class="amount" value="${finance.landMoney}"  maxlength="12" style="border:none;float:left">
						</td>
					</tr>
				</c:if>
				<c:if test="${not empty finance.gpsMoney}">
					<tr>
						...
						<td colspan="3" style="position:relative">
							...
							<input type="text" name="gpsMoney" class="amount" value="${finance.gpsMoney}"  maxlength="12" style="border:none;float:left">
						</td>
					</tr>
				</c:if>
				<c:if test="${not empty finance.stopMoney}">
					<tr>
						...
						<td colspan="3" style="position:relative">
							...
							<input type="text" name="stopMoney" class="amount" value="${finance.stopMoney}"  maxlength="12" style="border:none;float:left">
						</td>
					</tr>
				</c:if>
				<c:if test="${not empty finance.jindiMoney}">
					<tr>
						...
						<td colspan="3" style="position:relative">
							...
							<input type="text" name="jindiMoney" class="amount" value="${finance.jindiMoney}"  maxlength="12" style="border:none;float:left">
						</td>
					</tr>
				</c:if>
				<c:if test="${not empty finance.fileMoney}">
					<tr>
						...
						<td colspan="3" style="position:relative">
							...
							<input type="text" name="fileMoney" class="amount" value="${finance.fileMoney}"   maxlength="12" style="border:none;float:left">
						</td>
					</tr>
				</c:if>
				<c:if test="${not empty finance.elseMoney}">
					<tr>
						...
						<td colspan="3" style="position:relative">
							...
							<input type="text" name="elseMoney" class="amount" value="${finance.elseMoney}" maxlength="12" style="border:none;float:left">
						</td>
					</tr>
				</c:if>
				...
				<p class="control_tab">
					<input type="button" value="通过" onclick="pass()"  class="bgbtn"/>
	
					<input type="button" value="打回" onclick="back()" style="background:#f45b63" class="bgbtn"/>
				</p>
			</form>
