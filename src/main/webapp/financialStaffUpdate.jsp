					...
					<form action="##" method="post" enctype="multipart/form-data" id="save">
						<table class="control_tab">
							<tr>
								...
								<td class="width_04">
									<input type="hidden" value="${staffVo.id}" name="id" id="staff_id"/>
									<input type="text"  value="${staffVo.job_number}" name="job_number" id="job_number" placeholder="请输入工号" >
								</td>
								...
								<td class="width_04">
									<input type="hidden" value="${staffVo.district_id}" name="area" id="inputArea"/>
							...
							<tr>
								...
								<td class="width_04">
									<input type="hidden" value="${staffVo.branch_id}" name="dep_name" id="inputBranch"/>
								...
								<td class="width_04">
									<input type="hidden" value="${staffVo.post_id}" name="post_name" id="inputPost"/>
							...
							<tr>
								...
								<td style="text-align:left">
									 <input class="easyui-datebox"  style=" border-color: 1.5px solid #d3c6ff;width:200px;height:40px;z-index:5" editable="false" type="text" value="${staffVo.entry_date}" placeholder="输入时间" id="times" name="entry_date" >
								</td>
								<td width="140px" class="tab_03"><b>是否转正</b></td>
								<td class="width_04">
									<input type="hidden" value="${staffVo.is_become}" name="is_become" id="inputis_become">
						...
						<p class="control_tab">
							<input type="button" value="保存" class="bgbtn" id="sub_form" onclick="update()">
