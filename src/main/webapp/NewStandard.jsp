...
<div class="content">
	<div class="control">
		<form action="##" id="save" target="nm_iframe" method="post" enctype="multipart/form-data">
				...
				<tr>
					...
					<td class="width_01">
						<!-- <select name="riskman" id="riskman">
									...
									</select> --> <input type="text" name="money" maxlength="8" onkeyup="clearNoNum(this)" onblur="clearNoNum(this)" id="money" value="${username}">
			...
			<p style="margin-left: 120px;">科目：</p>
			<table id="myTables" class="control_tab controls_table" style="text-align: center; width: 865px;" border="1">
				<tr>
					<td width="143px" class="td_pos">借款</td>
					<td colspan="3" style="position: relative"><img class="tab_img" src="images/tab_add.png" id="addRows"> <img src="images/tab_det.png" id="deleteRow" onclick="delRow('del1');"> <input type="text" name="" class="amount" placeholder="一级科目"> <input type="text" name="" class="amount" placeholder="二级科目"> <input type="text" name="" class="amount" placeholder="三级科目"></td>
				</tr>
				<tr>
					<td colspan="2" width="400px"></td>
					<td width="105px" id="sumAdds">合计</td>
					<td width="110px" id="td_Amounts"><input type="text" name="sum" value="" readonly style="border: none"></td>
				</tr>
			</table>
			<table id="myTabless" class="control_tab controls_table" style="text-align: center; width: 865px;" border="1">
				<tr>
					<td width="143px" class="td_pos">贷款</td>
					<td colspan="3" style="position: relative"><img class="tab_img" src="images/tab_add.png" id="addRowss"> <img src="images/tab_det.png" id="deleteRow" onclick="delRow('del1');"> <input type="text" name="" class="amount" placeholder="一级科目"> <input type="text" name="" class="amount" placeholder="二级科目"> <input type="text" name="" class="amount" placeholder="三级科目"></td>
				</tr>
				<tr>
					<td colspan="2" width="400px"></td>
					<td width="105px" id="sumAddss">合计</td>
					<td width="110px" id="td_Amountss"><input type="text" name="sum" value="" readonly style="border: none"></td>
				</tr>
			</table>
			<p class="control_tab">
				<input type="button" value="保存" onclick="add()" class="bgbtn" id="sub_form" /> <input type="button" onclick="add1()" value="提交" style="background: #f5ba31" class="bgbtn" /> <input type="reset" onclick="cancel()" value="取消" style="background: #f45b63" class="bgbtn" />
			</p>
		</form>
...
<script type="text/javascript">
	window.onload = function() {
		...
		var btn2 = document.getElementById("addRows");
		var btn3 = document.getElementById("addRowss");
		...
		btn2.onclick = function() {
			...
			var rowIndex = myTable.rows.length - 1;
			var newRow = myTable.insertRow(rowIndex);
			newRow.id = "rows" + rowIndex;
			newRow.className = "pos";
			newRow.innerHTML = "<td width='143px' class='td_pos'>借款</td><td colspan='3' style='position:relative'><input type='text' name='' class='amount' placeholder='一级科目'><input type='text' name='' class='amount' placeholder='二级科目'><input type='text' name='' class='amount' placeholder='三级科目'><img src='images/tab_det.png' id='deleteRow' onclick=\'delRow(rows"
					+ rowIndex + ");\'></td>"
		}
		btn3.onclick = function() {
			var myTable = document.getElementById("myTabless");
			var rowIndex = myTable.rows.length - 1;
			var newRow = myTable.insertRow(rowIndex);
			newRow.id = "rowss" + rowIndex;
			newRow.className = "pos";
			newRow.innerHTML = "<td width='143px' class='td_pos'>贷款</td><td colspan='3' style='position:relative'><input type='text' name='' class='amount' placeholder='一级科目'><input type='text' name='' class='amount' placeholder='二级科目'><input type='text' name='' class='amount' placeholder='三级科目'><img src='images/tab_det.png' id='deleteRow' onclick=\'delRow(rowss"
					+ rowIndex + ");\'></td>"
		}
	}
