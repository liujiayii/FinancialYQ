					...
					<input type="hidden" name="type" id="type" value="${finance.type}" >	
						<table class="control_tab">
							<tr>
								...
								<td width="84">金额</td>
								<td class="width_01" style="text-align:left"><input type="text" name="money" maxlength="8" onkeyup="clearNoNum(this)" onblur="clearNoNum(this)" id="money" value="${finance.money}" style="width:115
							...
							<tr>
								...
								<td width="79">标号</td>
								<td class="width_01">
									<input type="text" name="grade" value="${finance.grade}"  placeholder="请输入标号"  maxlength="8" >
								</td>
								...
								<tr>
								<td width="79">旧标号</td>
								<td class="width_01"><input type="text" name="formergrade" value="${finance.formergrade}"  placeholder="输入旧标号"  maxlength="8"></td>
								<td width="79">期数</td>
						...
						<table id="myTable" class="control_tab controls_table" style="text-align:center;width:865px;"border="1">
							<c:if test="${not empty finance.refinancePlatform}">
								<tr>
									...
									<input type="text" name="refinancePlatform" class="amount" value="${finance.refinancePlatform}" maxlength="12" style="border:none;float:left">
									</td>
								</tr>
							</c:if>
							<c:if test="${not empty finance.maturityPlatform}">
								<tr>
									...
									<td colspan="3" style="position:relative">
									<input type="text" name="maturityPlatform" class="amount" value="${finance.maturityPlatform}" maxlength="12" style="border:none;float:left">
									</td>
								</tr>
							</c:if>
							<c:if test="${not empty finance.overduePlatform}">
								<tr>
									...
									<td colspan="3" style="position:relative">
									<input type="text" name="overduePlatform" class="amount" value="${finance.overduePlatform}" maxlength="12" style="border:none;float:left">
									</td>
								</tr>
							</c:if>
							<c:if test="${not empty finance.prepaymentPlatform}">
								<tr>
									...
									<td colspan="3" style="position:relative">
									<input type="text" name="prepaymentPlatform" class="amount" value="${finance.prepaymentPlatform}" maxlength="12" style="border:none;float:left">
									</td>
								</tr>
							</c:if>
							<tr>
