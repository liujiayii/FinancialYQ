...
<jsp:include page="nav.jsp"></jsp:include>
			<div class="content">
				...
				<div class="sel-list">
					<a href="toIncome.action">添加收入表</a>
					<a href="toServiceMoney.action">服务费表</a>
					<a href="toWithDraw.action" class="bold">提现手续费表</a>
				</div>
	...
	<script type="text/javascript">
		...
		$(function(){
			var url= "financialWithDraw.action";
				...
				console.log(res.length+"res.length")
					for (var i = 0; i < res.length; i++) {
									data[i] = {
										...
										操作 : "<a href='PrintWithDrawMoney.action?id="+res[i].id+"'><b style='color:#00a2ff'>打印</b></a>&nbsp;&nbsp;&nbsp;<a href='ShowWithDrawMoney.action?id="+res[i].id+"' ><b style='color:#00a2ff'>详情</b></a>"
									};
								}
								console.log(data)
								var cs = new table({
