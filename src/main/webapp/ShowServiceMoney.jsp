	...
	<div class="control">
		...
		<form action="##" id="save" target="nm_iframe" method="post" enctype="multipart/form-data">
			...
			<table id="myTable" class="control_tab controls_table" style="text-align: center; width: 800px;" border="1">
				...
				<tr>
					<td><input type="text" name="incomeAccount" value="${servicemoney.incomeAccount}" maxlength="30" style="border: none; float: left" id="number1"></td>
					<td><input type="text" name="remark" value="${servicemoney.remark}" maxlength="30" style="border: none; float: left" id="digest1"></td>
					<td colspan="3"><input type="text" name="money" value="${servicemoney.money}" class="amount" onkeyup="clearNoNum(this)" onblur="clearNoNum(this)" maxlength="12" style="border: none; float: left" id="sum1"></td>
				</tr>
				<tr>
