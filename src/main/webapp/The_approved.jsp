	...
	function findGrade() {
		...
		$.getJSON(url, function(res) {
			...
			for (var i = 0; i < res.length; i++) {
				...
				if (res[i].audit_id == 0) {
					state = "续贷";
					print = "<b style='color:#0CA1EF;cursor: pointer;'' onclick=\"window.location.href='printXD.action?id=" + res[i].id
							+ "'\">打印</b>&nbsp;&nbsp;&nbsp;<b style='color:red; cursor: pointer;'  onclick='nullify(" + res[i].id + ")'>作废</b>";
					...
					state = "新标";
					print = "<b style='color:#0CA1EF;cursor: pointer;'' onclick=\"window.location.href='printXB.action?id=" + res[i].id
							+ "'\">打印</b>&nbsp;&nbsp;&nbsp;<b style='color:red;cursor: pointer;' onclick='nullify(" + res[i].id + ")'>作废</b>";
					...
					if (res[i].state == 0) { //res[i].state判断是谁填的表 0代表风控 1代表财务
						print = "<b style='color:#0CA1EF;cursor: pointer;'' onclick=\"window.location.href='Printfkbj.action?id=" + res[i].id
								+ "'\">打印</b>&nbsp;&nbsp;&nbsp;<b style='color:red;cursor: pointer;' onclick='nullify(" + res[i].id + ")'>作废</b>";
						...
						print = "<b style='color:#0CA1EF;cursor: pointer;'' onclick=\"window.location.href='Printcwbj.action?id=" + res[i].id
								+ "'\">打印</b>&nbsp;&nbsp;&nbsp;<b style='color:red;cursor: pointer;' onclick='nullify(" + res[i].id + ")'>作废</b>";
					...
					state = "利息";
					if (res[i].state == 0) { //res[i].state判断是谁填的表 0代表风控 1代表财务
						print = "<b style='color:#0CA1EF;cursor: pointer;'' onclick=\"window.location.href='Printfklx.action?id=" + res[i].id
								+ "'\">打印</b>&nbsp;&nbsp;&nbsp;<b style='color:red;cursor: pointer;' onclick='nullify(" + res[i].id + ")'>作废</b>";
						showDetail = "<b style='color:#0CA1EF;cursor: pointer;'onclick=\"window.location.href='toShowInterestfk.action?id=" + res[i].id + "'\">查看详情</b>";
					} else if (res[i].state == 1) {
						print = "<b style='color:#0CA1EF;cursor: pointer;'' onclick=\"window.location.href='Printcwlx.action?id=" + res[i].id
								+ "'\">打印</b>&nbsp;&nbsp;&nbsp;<b style='color:red;cursor: pointer;' onclick='nullify(" + res[i].id + ")'>作废</b>";
		...
		if (c == '风控' || c == '出纳') {
			...
			$.getJSON(url, function(res) {
				...
				for (var i = 0; i < res.length; i++) {
					...
					if (res[i].audit_id == 0) {
						state = "续贷";
						print = "<b class='dy' style='color:#0CA1EF;cursor: pointer; display:none'' onclick=\"window.location.href='printXD.action?id=" + res[i].id
								+ "'\">打印</b>&nbsp;&nbsp;&nbsp;<b class='zf' style='color:red; cursor: pointer;display:none'  onclick='nullify(" + res[i].id + ")'>作废</b>";
						showDetail = "<b style='color:#0CA1EF;cursor: pointer;' onclick=\"window.location.href='toShowDetails.action?id=" + res[i].id + "'\">查看详情</b>"
					} else if (res[i].audit_id == 1) {
						state = "新标";
						print = "<b class='dy' style='color:#0CA1EF;cursor: pointer;display:none'' onclick=\"window.location.href='printXB.action?id=" + res[i].id
								+ "'\">打印</b>&nbsp;&nbsp;&nbsp;<b class='zf' style='color:red;cursor: pointer;display:none' onclick='nullify(" + res[i].id + ")'>作废</b>";
						showDetail = "<b style='color:#0CA1EF;cursor: pointer;'onclick=\"window.location.href='toShowDetails1.action?id=" + res[i].id + "'\">查看详情</b>";
					} else if (res[i].audit_id == 2) {
						state = "本息";
						/* 	if(res[i].state==0){ *///res[i].state判断是谁填的表 0代表风控 1代表财务
						print = "<b class='dy' style='color:#0CA1EF;cursor: pointer;display:none'' onclick=\"window.location.href='Printcwbj.action?id=" + res[i].id
								+ "'\">打印</b>&nbsp;&nbsp;&nbsp;<b class='zf' style='color:red;cursor: pointer;display:none' onclick='nullify(" + res[i].id + ")'>作废</b>";
						showDetail = "<b style='color:#0CA1EF;cursor: pointer;'onclick=\"window.location.href='toShowPrincipalcw.action?id=" + res[i].id + "'\">查看详情</b>";
						/* 	} *//* else if(res[i].state==1){
