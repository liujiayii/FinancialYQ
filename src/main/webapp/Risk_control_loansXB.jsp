...
<div class="content">
	<div class="control">
		...
		<form action="##" id="save" target="nm_iframe" method="post" enctype="multipart/form-data">
			<input type="hidden" name="s_id" id="s_id"> <input type="hidden" name="audit_id" id="audit_id" value="${finance.audit_id}">
			...
			<table class="control_tab">
				<tr>
					...
					<td width="79">期限</td>
					<td class="width_01"><input type="text" name="day" value="${finance.day}个月"></td>
				</tr>
				<tr>
					<td class="tab_01">业务类型</td>
					<td class="width_01"><input type="hidden" id="selectBusinessType" value="${finance.businessType}" /> <select name="businessType" id="businessType">
					...
					<td width="185" class="input_hove"><input type="text" name="time" value="${strDate}"></td>
			...
			<table id="myTable" class="control_tab controls_table" style="text-align: center; width: 865px;" border="1">
				...
				<c:if test="${not empty finance.principal}">
					<tr>
						<td width="143px" class="td_pos">还本金</td>
						<td colspan="3" style="position: relative">
