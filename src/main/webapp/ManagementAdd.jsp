...
<jsp:include page="nav.jsp"></jsp:include>
	        ...
	        <div class="form-layer">
    			<span>工号</span>
    				<input type="text" class="form-input" name="job_number" id="job_number" maxlength="10"/>
    				<div class="error" id="job_number-error"></div>
    		</div>
			<div class="form-layer">
    			<span>姓名</span>
    				<input type="text" class="form-input" name="name" id="name" maxlength="6"/>
    				<input type="hidden" value="${name}" name="district_id">
