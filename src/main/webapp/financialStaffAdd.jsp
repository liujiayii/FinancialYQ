		...
		<form action="##" method="post" enctype="multipart/form-data" id="save">
			<table class="control_tab">
				<tr>
					...
					<td class="width_04"><input type="hidden" value="" name="id" id="staff_id" /> <!-- this.value=this.value.replace(/[^\d]/g,''); --> <input type="text" value="" name="job_number" id="job_number" placeholder="请输入工号" onkeyup="findJobNum()"></td>
					...
					<td class="width_04"><select name="district_id" id="area">
				...
				<tr>
					...
					<td class="width_04"><select name="branch_id" id="branch">
					...
					<td class="width_04"><select name="post_id" id="position">
				...
				<tr>
					...
					<td style="text-align: left"><input class="easyui-datetimebox" style="border-color: 1.5px solid #d3c6ff; width: 200px; height: 40px; z-index: 5" editable="false" type="text" value="" placeholder="输入时间" id="times" name="entry_date"></td>
					<td width="140px" class="tab_03"><b>是否转正</b></td>
					<td class="width_04"><select name="is_become" id="is_become">
			...
			<p class="control_tab">
				<input type="button" value="保存" class="bgbtn" id="sub_form" onclick="add()"> <input type="button" value="取消" class="bgbtn" style="background: #f45b63" onclick="window.location.href='toStaff.action'">
			</p>
		</form>
