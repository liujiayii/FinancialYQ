			...
			<div class="content">
				...
				<c:if test="${not empty finance.refinancePlatform}">
					<tr>
						...
						<td colspan="3" style="position:relative">						
							<input type="text" name="refinancePlatform" class="amount" value="${finance.refinancePlatform}" onkeyup="clearNoNum(this)" onblur="clearNoNum(this)"  maxlength="12" style="border:none;float:left">
						</td>
					</tr>
					</c:if>
				<c:if test="${not empty finance.maturityPlatform}">
					<tr>
						...
						<td colspan="3" style="position:relative">							
							<input type="text" name="maturityPlatform" class="amount" value="${finance.maturityPlatform}" onkeyup="clearNoNum(this)" onblur="clearNoNum(this)" maxlength="12" style="border:none;float:left">
						</td>
					</tr>
				</c:if>
				...
				<c:if test="${not empty finance.overduePlatform}">
					<tr>
						...
						<td colspan="3" style="position:relative">												
							<input type="text" name="overduePlatform" class="amount" value="${finance.overduePlatform}" onkeyup="clearNoNum(this)" onblur="clearNoNum(this)" maxlength="12" style="border:none;float:left">
						</td>
					</tr>
				</c:if>
				<c:if test="${not empty finance.prepaymentPlatform}">
					<tr>
						...
						<td colspan="3" style="position:relative">						
							<input type="text" name="prepaymentPlatform" class="amount" value="${finance.prepaymentPlatform}" onkeyup="clearNoNum(this)" onblur="clearNoNum(this)" maxlength="12" style="border:none;float:left">
						</td>
					</tr>
				</c:if>				
							<tr>
...
<jsp:include page="footer.jsp"></jsp:include>
	...
	<script type="text/javascript">
		function addText(a){
			a.html('');
			if(a.html().trim()==''){
				a.append('<div class="div_dis"><input type="text" class="frame-style" readonly="readonly" value=" " disabled/><img src="images/bg_arr.png" class="bg_arri" /></div><ul class="menue-list"><li id="refinancePlatform">续贷还平台</li><li id="maturityPlatform">到期还平台</li><li id="overduePlatform">逾期还平台</li><li id="prepaymentPlatform">提前还平台</li></ul>');
			}else{
				return false;
			}
			$('.menue-list li').click(function(){
				...
				if(tdInterHTML.text() == "续贷还平台"){					
					tdInterHTML.next().children(".amount").attr('name','refinancePlatform');
				}else if(tdInterHTML.text() == "到期还平台"){
					tdInterHTML.next().children(".amount").attr('name','maturityPlatform');
				}else if(tdInterHTML.text() == "逾期还平台"){
					tdInterHTML.next().children(".amount").attr('name','overduePlatform');
				}else if(tdInterHTML.text() == "提前还平台"){
					tdInterHTML.next().children(".amount").attr('name','prepaymentPlatform');
				}
