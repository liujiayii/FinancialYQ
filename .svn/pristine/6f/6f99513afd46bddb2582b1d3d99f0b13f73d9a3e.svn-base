	...
	<body>
		<div class="main">  
			<div class="article_main">
				<h3><img src="images/s_logo.png">财务发票系统</h3>
				<div class="matter">
					<form action="login.action" method="post" id="fin_form">
						<div class="details">
							<input type="text" maxlength="11"  name="username" placeholder="请输入账号" onkeyup="findUsername()" class="inputs verify" id="fin_account" autocomplete="off"/>
							<img src="images/account.png" class="img_01"/>
							<p class="explain1"></p>
						</div>
						<div class="details">
							<input type="password" name="password" placeholder="请输入密码" onblur="findPass()" id="fin_pwd" class="inputs verify" />
							<img src="images/password.png" class="img_01"/>
							<p class="explain2"></p>
						</div>
						<div class="details">
							<input type="hidden" value="${result}">
							<input type="text" name="auth_code" placeholder="请输入验证码" value="" maxlength="2" autocomplete="off" id="fin_code" class="validation verify"/>
							<img id="img" class="auth_code" src="showAuthCode.action">
