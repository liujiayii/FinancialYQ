...
<div class="content">
	...
	<div class="control">
		...
		<form action="##" id="save" target="nm_iframe" method="post" enctype="multipart/form-data">
			...
			<input type="hidden" name="s_id" id="s_id"> <input type="hidden" name="audit_id" id="audit_id"> <input type="hidden" name="types" id="types" value="${finance.types}"> <input type="hidden" name="type" id="type" value="${finance.type}">
			<table class="control_tab">
				<tr>
					...
					<td width="79">姓名</td>
					<td class="width_01"><input type="text" name="name" id="names" value="${finance.name}"></td>
					<td width="84">金额</td>
			...
			<table id="myTable" class="control_tab controls_table" style="text-align: center; width: 865px;" border="1">
				<c:if test="${not empty finance.interest}">
					<tr>
						<td width="116px" class="td_pos">平台服务费+利息（风）</td>
