...
<jsp:include page="nav.jsp"></jsp:include>
			...
			<div class="popup" id="popup">
	        	<form id="ff">
	        		...
	        		<div class="popup-layer" style="text-align: center;">
	        			<input type="button" class="popup-sub"  value="添加" onclick="add()"/>
	       ...
	       <div class="popup" id="popup-edit">
	        	<form id="ff-edit">
	        		...
	        		<div class="popup-layer" style="text-align: center;">
	        			<input type="button" class="popup-sub"  value="保存" onclick="saveEdit()"/>
	        			<input type="button" value="取消" class="popup-return"/>
	        		</div>       		
	        	</form>
	        </div>
		...
		$(function(){
			...
			$.getJSON(url,function(res){
				...
				for(var i=0;i<res.length;i++){
				   data[i] = {id:res[i].id,area:res[i].area,area_code:res[i].area_code,time:getTime(res[i].create_time),操作:"<a onclick='edit("+res[i].id+","+JSON.stringify(res[i].area)+","+JSON.stringify(res[i].area_code)+")'><img src='images/editors.png'></a>"};
