		...
		<form action="##" id="updateStatus" target="nm_iframe" method="post" enctype="multipart/form-data">
			...
			<table id="myTable" class="control_tab controls_table" style="text-align: center; width: 865px;" border="1">
				<c:if test="${not empty finance.refinancePrincipal}">
					<tr>
						<td width="116px" class="td_pos">续贷还本</td>
						<td colspan="3" style="position: relative"><input type="text" name="refinancePrincipal" class="amount" value="${finance.refinancePrincipal}" onkeyup="clearNoNum(this)" onblur="clearNoNum(this)" maxlength="12" style="border: none; float: left"></td>
					</tr>
				</c:if>
				<c:if test="${not empty finance.maturityPrincipal}">
					<tr>
						<td width="143px" class="td_pos">到期还本</td>
						<td colspan="3" style="position: relative"><input type="text" name="maturityPrincipal" class="amount" value="${finance.maturityPrincipal}" onkeyup="clearNoNum(this)" onblur="clearNoNum(this)" maxlength="12" style="border: none; float: left"></td>
					</tr>
				</c:if>

				<c:if test="${not empty finance.prepaymentPrincipal}">
					<tr>
						<td width="116px" class="td_pos">提前还本</td>
						<td colspan="3" style="position: relative"><input type="text" name="prepaymentPrincipal" class="amount" value="${finance.prepaymentPrincipal}" onkeyup="clearNoNum(this)" onblur="clearNoNum(this)" maxlength="12" style="border: none; float: left"></td>
					</tr>
				</c:if>
				<c:if test="${not empty finance.overduePrincipal}">
					<tr>
						<td width="116px" class="td_pos">逾期还本</td>
						<td colspan="3" style="position: relative"><input type="text" name="overduePlatform" class="amount" value="${finance.overduePrincipal}" onkeyup="clearNoNum(this)" onblur="clearNoNum(this)" maxlength="12" style="border: none; float: left"></td>
					</tr>
				</c:if>
				<tr>
