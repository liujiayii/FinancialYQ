...
<div class="content">
	<div class="control">
		<form action="##" id="save" target="nm_iframe" method="post" enctype="multipart/form-data">
			<input type="hidden" name="s_id" id="s_id"> <input type="hidden" name="audit_id" id="audit_id" value="${finance.audit_id}"> <input type="hidden" name="id" id="id" value="${finance.id}"> <input type="hidden" name="types" id="types" value="${finance.types}"> <input type="hidden" name="type" id="type" value="${finance.type}">
			...
			<table id="myTable" class="control_tab controls_table" style="text-align: center; width: 865px;" border="1">
				...
				<c:if test="${not empty finance.principal}">
					<tr>
						<td width="116px" class="td_pos" onclick="addText($(this))">还本金</td>
						<td colspan="3" style="position: relative">
				...
				<c:if test="${not empty finance.interest}">
					<tr>
						<td width="143px" class="td_pos" onclick="addText($(this))">平台服务费+利息</td>
						<td colspan="3" style="position: relative">
				...
				<c:if test="${not empty finance.serviceMoney}">
					<tr>
						<td width="116px" class="td_pos" onclick="addText($(this))">点位费</td>
						<td colspan="3" style="position: relative">
				...
				<c:if test="${not empty finance.houseProperty}">
					<tr>
						<td width="116px" class="td_pos" onclick="addText($(this))">房产费</td>
						<td colspan="3" style="position: relative">
				...
				<c:if test="${not empty finance.archivesMoney}">
					<tr>
						<td width="116px" class="td_pos" onclick="addText($(this))">档案费</td>
						<td colspan="3" style="position: relative">
				...
				<c:if test="${not empty finance.capitalMoney}">
					<tr>
						<td width="116px" class="td_pos" onclick="addText($(this))">垫资费</td>
						<td colspan="3" style="position: relative">
				...
				<c:if test="${not empty finance.account}">
					<tr>
						<td width="116px" class="td_pos" onclick="addText($(this))">过账</td>
						<td colspan="3" style="position: relative">
				...
				<c:if test="${not empty finance.landMoney}">
					<tr>
						<td width="116px" class="td_pos" onclick="addText($(this))">实地费</td>
						<td colspan="3" style="position: relative">
				...
				<c:if test="${not empty finance.gpsMoney}">
					<tr>
						<td width="116px" class="td_pos" onclick="addText($(this))">GPS安装</td>
						<td colspan="3" style="position: relative">
				...
				<c:if test="${not empty finance.stopMoney}">
					<tr>
						<td width="116px" class="td_pos" onclick="addText($(this))">停车费</td>
						<td colspan="3" style="position: relative">
				...
				<c:if test="${not empty finance.jindiMoney}">
					<tr>
						<td width="116px" class="td_pos" onclick="addText($(this))">进抵费</td>
						<td colspan="3" style="position: relative">
				...
				<c:if test="${not empty finance.fileMoney}">
					<tr>
						<td width="116px" class="td_pos" onclick="addText($(this))">查档费</td>
						<td colspan="3" style="position: relative">
				...
				<c:if test="${not empty finance.elseMoney}">
					<tr>
						<td width="116px" class="td_pos" onclick="addText($(this))">他项费</td>
						<td colspan="3" style="position: relative">
