		...
		<form action="##" id="save" method="post" enctype="multipart/form-data">
			...
			<table class="control_tab">
				<tr>
					...
					<td width="84">金额</td>
					<td class="width_01" style="text-align: left"><input type="text" name="money" maxlength="8" id="money" value="${finance.money}" style="width: 115 px" placeholder="请输入金额"></td>
					<td width="79">期限</td>
				...
				<tr>
					...
					<td width="79">客户经理</td>
					<td class="width_01"><input type="hidden" value="${finance.s_id}" id="selectMan" name="s_id"> <select id="salesman" name="s_id" class="width_01">
			...
			<table id="myTable" class="control_tab controls_table" style="text-align: center; width: 865px;" border="1">
				<c:if test="${not empty finance.refinancePrincipal}">
					<tr>
						...
						<td colspan="3" style="position: relative"><input type="text" name="refinancePrincipal" class="amount" value="${finance.refinancePrincipal}" maxlength="12" style="border: none; float: left"></td>
					</tr>
				</c:if>
				<c:if test="${not empty finance.maturityPrincipal}">
					<tr>
						<td width="116px" class="td_pos">到期还本</td>
						<td colspan="3" style="position: relative"><input type="text" name="maturityPrincipal" class="amount" value="${finance.maturityPrincipal}" maxlength="12" style="border: none; float: left"></td>
					</tr>
				</c:if>
				<c:if test="${not empty finance.overduePrincipal}">
					<tr>
						<td width="116px" class="td_pos">逾期还本</td>
						<td colspan="3" style="position: relative"><input type="text" name="overduePrincipal" class="amount" value="${finance.overduePrincipal}" maxlength="12" style="border: none; float: left"></td>
					</tr>
				</c:if>
				<c:if test="${not empty finance.prepaymentPrincipal}">
					<tr>
						<td width="116px" class="td_pos">提前还本</td>
						<td colspan="3" style="position: relative"><input type="text" name="prepaymentPrincipal" class="amount" value="${finance.prepaymentPrincipal}" maxlength="12" style="border: none; float: left"></td>
					</tr>
				</c:if>
				<tr>
