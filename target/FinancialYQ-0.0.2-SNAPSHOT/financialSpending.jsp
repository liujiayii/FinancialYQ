	...
	<div class="content">
		<div class="sub-box">
			...
			<div class="sub-right">
				...
				<input type="button" value="添加" class="sub-button" onclick="window.location.href='toShowAddSpend.action'"/>
			</div>
		</div>
			...
			$.getJSON(url,function(res){
				...
				for (var i = 0; i < res.length; i++) {
						data[i] = {
							...
							操作 :res[i].state ==1? "<a href='printSpend.action?id="+res[i].id+"' ><b style='color:#00a2ff'>打印</b></a>&nbsp;&nbsp;&nbsp;<a href='toShowfinancialSpend.action?id="+res[i].id+"' ><b style='color:#00a2ff'>详情</b></a>&nbsp;&nbsp;&nbsp;<a href='todeleteSpend.action?id="+res[i].id+"' ><b style='color:#00a2ff'>作废</b>":"<a href='toShowfinancialSpend.action?id="+res[i].id+"' ><b style='color:#00a2ff'>详情</b></a>&nbsp;&nbsp;&nbsp;<a href='todeleteSpend.action?id="+res[i].id+"' ><b style='color:#00a2ff'>作废</b>"
						};
					}
				console.log(data)
				var cs = new table({
					"tableId" : "cs_table", //必须
					"headers" : [ "序号", "支出项目标题 ", "时间", "状态","操作" ], //必须
					"data" : data, //必须
