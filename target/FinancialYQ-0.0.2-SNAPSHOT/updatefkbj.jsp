			...
			<div class="content">
					...
					<input type="hidden" name="type" id="type" value="${finance.type}">
						<table class="control_tab">
							...
							<tr>
								...
								<td width="79">期数</td>
								<td class="width_01"><input type="text" name="period" value="${finance.period}" id="period" maxlength="4"   ></td>
				...
				<c:if test="${not empty finance.overduePrincipal}">
					<tr>
						...
						<td colspan="3" style="position:relative">						
							<input type="text" name="overduePrincipal" class="amount" value="${finance.overduePrincipal}" onkeyup="clearNoNum(this)" onblur="clearNoNum(this)" maxlength="12" style="border:none;float:left">
						</td>
					</tr>
				</c:if>				
							<tr>
							...
							<p class="control_tab">
								...
								<input class="bgbtn" onclick="javascript:history.back(-1);" type="button" value="取消" style="background:#f45b63">
							</p>
					</form>
