			...
			<div class="content">
				...
				<div class="control">
					<form action="##" id="updateState" method="post" enctype="multipart/form-data">
						...
						<input type="hidden" name="state" id="state" value="${income.state}"> 
					</form>
					<form action="##" id="save" target="nm_iframe" method="post" enctype="multipart/form-data">
						...
						<table class="control_tab">
							<tr>
								...
								<td class="width_01">
									<input type="text" value="${income.name}" name="name" maxlength="5">
									
									<!-- <select id ="name" name="name" class="width_01" >
