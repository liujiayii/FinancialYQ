...
<div class="content">
	...
	<div class="control">
		<form action="##" id="updateState" method="post" enctype="multipart/form-data">
			<input type="hidden" name="id" id="id" value="${spend.id}"> <input type="hidden" name="state" id="state" value="${spend.state}">
		</form>
		<form action="##" id="save" target="nm_iframe" method="post" enctype="multipart/form-data">
			...
			<table class="control_tab">
				<tr>
					...
					<td class="width_01"><input type="hidden" name="district_id" value="${spend.district_id}" id="selectArea"> <select id="area" name="district_id">
					...
					<td class="width_01"><input type="text" value="${spend.name}" name="name"></td>
