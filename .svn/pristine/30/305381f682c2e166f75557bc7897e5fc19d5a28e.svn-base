						...
						<table class="control_tab">
							...
							<table id="myTable" class="control_tab controls_table" style="text-align:center;width:865px;"border="1">
								<c:if test="${not empty finance.interest}">
									<tr>
										<td width="116px" class="td_pos">平台服务费+利息（风控）</td>
							...
							<p class="control_tab">
								...
								<input class="bgbtn" onclick="window.location.href = 'toShowUnchecked.action'" type="button" value="取消" style="background:#f45b63">
							</p>
					</form>
