		...
		<form action="##" id="save" target="nm_iframe" method="post" enctype="multipart/form-data">
			...
			<table class="control_tab">
				<tr>
					...
					<td width="79">姓名</td>
					<td class="width_01"><input type="text" name="name" id="names" value="" placeholder="输入姓名"></td>
					<td width="84">金额</td>
				...
				<tr>
					<td width="79">建表人</td>
					<td class="width_01"><select name="riskman" id="riskman">
			...
			<table id="myTable" class="control_tab controls_table" style="text-align: center; width: 865px;" border="1">
				<tr>
					...
					<td colspan="3" style="position: relative"><img class="tab_img" src="images/tab_add.png" id="addRow"> <img src="images/tab_det.png" id="deleteRow" onclick="delRow('del1');"> <input type="text" name="" value="" class="amount" onkeyup="clearNoNum(this)" onblur="clearNoNum(this)" maxlength="12" style="border: none; float: left"></td>
				</tr>
				<tr>
...
<script type="text/javascript">
	window.onload = function() {
		...
		btn1.onclick = function() {
			...
			newRow.innerHTML = '<td class="td_pos" width="116px" onclick="addText($(this))"></td><td colspan="3" style="position:relative"><input type="text" maxlength="12" class="amount" name="" value=""  onkeyup="clearNoNum(this)" onblur="clearNoNum(this)" style="border:none;float:left"><img src="images/tab_det.png" id="deleteRow" onclick=\"delRow(row'
					+ rowIndex + ');\"></td>'
		}
	}
