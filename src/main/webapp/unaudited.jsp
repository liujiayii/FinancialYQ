	...
	$(function() {
		...
		$.getJSON(url, function(res) {
			...
			for (var i = 0; i < res.length; i++) {
				...
				//续贷审核
				var sh1 = "<b class='sh' style='color:#0CA1EF;cursor: pointer;display:none' onclick=\"window.location.href='Risk_control_loansXD.action?id=" + res[i].id
						+ "'\">审核</b>";
				//新标审核
				var sh2 = "<b class='sh' style='color:#0CA1EF;cursor: pointer;display:none' onclick=\"window.location.href='Risk_control_loansXB.action?id=" + res[i].id
						+ "'\">审核</b>";
				//风控本金审核
				var sh3 = "<b class='sh' style='color:#0CA1EF;cursor: pointer;display:none' onclick=\"window.location.href='Checkfkbj.action?id=" + res[i].id + "'\">审核</b>";
				//财务本金审核
				var sh4 = "<b class='sh' style='color:#0CA1EF;cursor: pointer;display:none' onclick=\"window.location.href='Checkcwbj.action?id=" + res[i].id + "'\">审核</b>";
				//风控利息审核
				var sh5 = "<b class='sh' style='color:#0CA1EF;cursor: pointer;display:none' onclick=\"window.location.href='Checkfklx.action?id=" + res[i].id + "'\">审核</b>";
				//财务利息审核
				var sh6 = "<b class='sh' style='color:#0CA1EF;cursor: pointer;display:none' onclick=\"window.location.href='Checkcwlx.action?id=" + res[i].id + "'\">审核</b>";
