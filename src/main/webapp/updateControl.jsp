...
<div class="content">
	<div class="control">
		<form action="##" id="update" target="nm_iframe" method="post" enctype="multipart/form-data">
			...
			<input type="hidden" name="audit_id" id="audit_id"> <input type="hidden" name="id" id="id" value="${finance.id}"> <input type="hidden" name="types" id="types" value="${finance.types}"> <input type="hidden" name="type" id="type" value="${finance.type}">
			<table class="control_tab">
				...
				<tr>
					<td width="79">建表人</td>
					<td class="width_01"><input type="hidden" value="${finance.riskman}" id="selectRiskman"> <select name="riskman" id="riskman">
			...
			<table id="myTable" class="control_tab controls_table" style="text-align: center; width: 865px;" border="1">
				<c:if test="${not empty finance.principal}">
					<tr>
						<td width="116px" class="td_pos">还本金</td>
						<td colspan="3" style="position: relative">
							<!-- <img src="images/tab_det.png" id="deleteRow"  onclick="delRow('del1');"> --> <input type="text" name="principal" class="amount" value="${finance.principal}" onkeyup="clearNoNum(this)" onblur="clearNoNum(this)" maxlength="12" style="border: none; float: left">
						</td>
					</tr>
				</c:if>
				<c:if test="${not empty finance.interest}">
					<tr>
						...
						<td colspan="3" style="position: relative">
							<!-- <img src="images/tab_det.png" id="deleteRow"  onclick="delRow('del1');"> --> <input type="text" name="interest" class="amount" value="${finance.interest}" onkeyup="clearNoNum(this)" onblur="clearNoNum(this)" maxlength="12" style="border: none; float: left">
						</td>
					</tr>
				</c:if>
				<c:if test="${not empty finance.serviceMoney}">
					<tr>
						<td width="116px" class="td_pos">点位费</td>
						<td colspan="3" style="position: relative">
							<!-- 	<img src="images/tab_det.png" id="deleteRow"  onclick="delRow('del1');"> --> <input type="text" name="serviceMoney" class="amount" value="${finance.serviceMoney}" onkeyup="clearNoNum(this)" onblur="clearNoNum(this)" maxlength="12" style="border: none; float: left">
						</td>
					</tr>
				</c:if>
				<c:if test="${not empty finance.houseProperty}">
					<tr>
						<td width="116px" class="td_pos">房产费</td>
						<td colspan="3" style="position: relative">
							<!-- <img src="images/tab_det.png" id="deleteRow"  onclick="delRow('del1');"> --> <input type="text" name="houseProperty" class="amount" value="${finance.houseProperty}" onkeyup="clearNoNum(this)" onblur="clearNoNum(this)" maxlength="12" style="border: none; float: left">
						</td>
					</tr>
				</c:if>
				<c:if test="${not empty finance.archivesMoney}">
					<tr>
						<td width="116px" class="td_pos">档案费</td>
						<td colspan="3" style="position: relative">
							<!-- 	<img src="images/tab_det.png" id="deleteRow"  onclick="delRow('del1');"> --> <input type="text" name="archivesMoney" class="amount" value="${finance.archivesMoney}" onkeyup="clearNoNum(this)" onblur="clearNoNum(this)" maxlength="12" style="border: none; float: left">
						</td>
					</tr>
				</c:if>
				<c:if test="${not empty finance.capitalMoney}">
					<tr>
						<td width="116px" class="td_pos">垫资费</td>
						<td colspan="3" style="position: relative">
							<!-- <img src="images/tab_det.png" id="deleteRow"  onclick="delRow('del1');"> --> <input type="text" name="capitalMoney" class="amount" value="${finance.capitalMoney}" onkeyup="clearNoNum(this)" onblur="clearNoNum(this)" maxlength="12" style="border: none; float: left">
						</td>
					</tr>
				</c:if>
				<c:if test="${not empty finance.account}">
					<tr>
						...
						<td colspan="3" style="position: relative">
							<!-- 	<img src="images/tab_det.png" id="deleteRow"  onclick="delRow('del1');"> --> <input type="text" name="account" class="amount" value="${finance.account}" onkeyup="clearNoNum(this)" onblur="clearNoNum(this)" maxlength="12" style="border: none; float: left">
						</td>
					</tr>
				</c:if>
				<c:if test="${not empty finance.landMoney}">
					<tr>
						<td width="116px" class="td_pos">实地费</td>
						<td colspan="3" style="position: relative">
							<!-- <img src="images/tab_det.png" id="deleteRow"  onclick="delRow('del1');"> --> <input type="text" name="landMoney" class="amount" value="${finance.landMoney}" onkeyup="clearNoNum(this)" onblur="clearNoNum(this)" maxlength="12" style="border: none; float: left">
						</td>
					</tr>
				</c:if>
				<c:if test="${not empty finance.gpsMoney}">
					<tr>
						...
						<td colspan="3" style="position: relative">
							<!-- <img src="images/tab_det.png" id="deleteRow"  onclick="delRow('del1');"> --> <input type="text" name="gpsMoney" class="amount" value="${finance.gpsMoney}" onkeyup="clearNoNum(this)" onblur="clearNoNum(this)" maxlength="12" style="border: none; float: left">
						</td>
					</tr>
				</c:if>
				<c:if test="${not empty finance.stopMoney}">
					<tr>
						...
						<td colspan="3" style="position: relative">
							<!-- <img src="images/tab_det.png" id="deleteRow"  onclick="delRow('del1');"> --> <input type="text" name="stopMoney" class="amount" value="${finance.stopMoney}" onkeyup="clearNoNum(this)" onblur="clearNoNum(this)" maxlength="12" style="border: none; float: left">
						</td>
					</tr>
				</c:if>
				<c:if test="${not empty finance.jindiMoney}">
					<tr>
						...
						<td colspan="3" style="position: relative">
							<!-- <img src="images/tab_det.png" id="deleteRow"  onclick="delRow('del1');"> --> <input type="text" name="jindiMoney" class="amount" value="${finance.jindiMoney}" onkeyup="clearNoNum(this)" onblur="clearNoNum(this)" maxlength="12" style="border: none; float: left">
						</td>
					</tr>
				</c:if>
				<c:if test="${not empty finance.fileMoney}">
					<tr>
						...
						<td colspan="3" style="position: relative">
							<!-- <img src="images/tab_det.png" id="deleteRow"  onclick="delRow('del1');"> --> <input type="text" name="fileMoney" class="amount" value="${finance.fileMoney}" onkeyup="clearNoNum(this)" onblur="clearNoNum(this)" maxlength="12" style="border: none; float: left">
						</td>
					</tr>
				</c:if>
				<c:if test="${not empty finance.elseMoney}">
					<tr>
						...
						<td colspan="3" style="position: relative">
							<!-- <img src="images/tab_det.png" id="deleteRow"  onclick="delRow('del1');"> --> <input type="text" name="elseMoney" class="amount" value="${finance.elseMoney}" onkeyup="clearNoNum(this)" onblur="clearNoNum(this)" maxlength="12" style="border: none; float: left">
						</td>
					</tr>
				</c:if>
				<tr>
			...
			<p class="control_tab">
				<input class="bgbtn" onclick="update()" type="button" value="保存"> <input class="bgbtn" onclick="add1()()" type="button" value="提交" style="background: #f5ba31"> <input class="bgbtn" onclick="cancel()" type="button" value="取消" style="background: #f45b63">
			</p>
		</form>
...
<!--动态显示收据类型-->
	if ("${finance.receiptType}" == 1) {
		$("#type").html(" 续贷还平台");
	} else if ("${finance.receiptType}" == 2) {
		$("#type").html(" 到期还平台");
	} else if ("${finance.receiptType}" == 3) {
		$("#type").html(" 逾期还平台");
	} else if ("${finance.receiptType}" == 4) {
		$("#type").html(" 提前还平台");
	} else if ("${finance.receiptType}" == 5) {
		$("#type").html(" 续贷还本");
	} else if ("${finance.receiptType}" == 6) {
		$("#type").html(" 到期还本");
	} else if ("${finance.receiptType}" == 7) {
		$("#type").html(" 逾期还本");
	} else if ("${finance.receiptType}" == 8) {
		$("#type").html(" 提前还本");
	}
</script>
...
<script type="text/javaScript">
	$(function() {
		...
		$("#riskman option[value='" + f + "']").attr("selected", "selected");
