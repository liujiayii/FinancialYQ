		...
		<form action="##" id="save" target="nm_iframe" method="post" enctype="multipart/form-data">
			<table class="control_tab">
				<tr>
					...
					<td class="width_01"><select id="area" name="area">
					...
					<td class="width_01"><input type="text" value="" name="name" id="name" placeholder="请输入姓名"></td>
...
<script>
	layui.use('upload', function() {
		...
		var uploadInst = upload.render({
			elem : '#test1' //绑定元素
			,
			url : '/toAddSpendImg.action?id=$(#id).val()' //上传接口
			,
			multiple : true,
			data : {
				id : function() {
